    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dat_medidas', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('aluno', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='alunos.alunos')),
            ],
        ),
    ]
